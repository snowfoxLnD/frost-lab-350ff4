/* ═══════════════════════════════════════════════════════════════════
   ...
   • Справка о персонаже по 5 категориям
   ═══════════════════════════════════════════════════════════════════ */
(function(){
'use strict';
...
const HEADLINES=[
  ['СНЕЖНЫЙ ФРОНТ','Криосистема Снежных Полей сдвигается к юго-востоку — Линкон ожидает резкое похолодание к выходным.'],
  ['СВОДКА AKSO','Главный кардиохирург закрыл операционную в 04:12. Источники в больнице сообщают: пациент в стабильном состоянии.'],
  ['ПОДЗЕМКА ВНЕ СЕТКИ','Аномальная активность зафиксирована на третьем уровне World Underneath. EVER подтвердил отсутствие пострадавших.'],
  ['МУЗЫКА ГОРОДА','Концерт камерной классики в библиотеке Skyhaven собрал аншлаг. Один зритель ушёл, не дождавшись бис-номера.'],
  ['СЕВЕРНОЕ СИЯНИЕ','Возможен слабый авроральный отклик после полуночи — наблюдатели рекомендуют северные районы города.'],
  ['РЫНОК','Акции EonCore Tech закрылись с минус 4,7%. Аналитики не комментируют до завтрашнего отчёта.'],
  ['ОБРАЗОВАНИЕ','Skyhaven University Medical School выпустила очередной поток кардиохирургов. Средний возраст — 24,3 года.'],
  ['КУЛЬТУРА','Открылась выставка ледяных скульптур у северного входа Akso. Главный экспонат — олень в натуральную величину.'],
  ['ТРАНСПОРТ','Метро Линкона переходит на ночной режим. Последний поезд — в 01:30, дневные смены остаются прежними.'],
  ['СПОРТ','Зимний марафон Линкона установил рекорд: участники из Snowfield заняли весь подиум.'],
  ['ВОЛОНТЁРСТВО','«Котики Akso» открыли новые часы посещения. Пять пушистых пациентов, всё — для пациентов больницы.'],
  ['ВРАЧЕБНАЯ ТАЙНА','Источник в Evol-Cardiac Lab сообщил о новом результате по регенерации клапана. Публикация — после рецензирования.'],
  ['КРИО-РЕПОРТАЖ','В Snowfield за сутки выпало 38 см снега. Школы перешли на сокращённый день.'],
  ['ОТЧЁТ AEC','Лаборатория Evol-Cardiac подтвердила третий успешный эксперимент по восстановлению ткани миокарда.'],
  ['ОБЪЯВЛЕНИЕ','Akso Hospital ищет ночных дежурных. Резюме принимаются до конца месяца.'],
  ['КАЛЕНДАРЬ','Супермуна ожидается через неделю — обсерватория Skyhaven приглашает на ночные сессии наблюдения.'],
  ['КРИМИНАЛ','Тихая ночь в Линконе. Полиция отчиталась о шести вызовах за смену — все по мелочам.'],
...
const ZAYNE_SEARCHES=[
  ...
  'тёплое какао рецепт без сахара ингредиенты',
  'купить кашемировый шарф длинный тёмно-серый',
  'когда лучше сообщить пациентке что я волнуюсь',
  'опасные взаимодействия декофеинизированный кофе и гипотензивные',
  'расписание лекций Skyhaven осень 2026',
  'новые исследования протокор-синдром PubMed 2026',
  'регенерация миокарда последние публикации',
  'замена контактных линз по подписке Линкон',
  'как уговорить уйти с работы вовремя примеры',
  'оптимальный сон хирурга после ночного дежурства',
  'жёсткая обложка для блокнота A5 кожаная',
  'диссертация транспортировка донорских сердец 2025',
  'статистика операционной нагрузки Akso год',
  'старый Littmann мембрана для замены 4-го поколения',
  ...
  'идеи подарка на день рождения для близкого человека',
  'EKG норма у молодого взрослого',
  'когда можно есть после 4-часовой операции',
  'снежный шар с оленем внутри купить',
  'правила перевозки криоконтейнера на самолёте',
  'школа классической гитары для занятых',
  'инструмент для резьбы по нефриту начинающие',
  ...
  'успокаивающее дыхание 4-7-8 техника',
];
...
const FACTS={
  'Профиль':[
    ['Имя','Zayne · 黎深 · Lí Shēn'],
    ['День рождения','5 сентября (Дева)'],
    ['Возраст','27 (родился 5.09.2021)'],
    ['Рост','≈ 187 см'],
    ['Глаза','ореховый зелёный'],
    ['Волосы','короткие чёрные, до основания шеи'],
    ['Очки','серебряная оправа, близорукость'],
    ['Особые приметы','шрамы на предплечьях и кистях'],
    ['Эвол','Лёд (чёрные ледяные кристаллы при активации)'],
    ['Группа крови','AB'],
  ],
  'Карьера и награды':[
    ['Должность','Главный кардиохирург, Akso Hospital (Linkon Central Hospital)'],
    ['Лаборатория','Старший исследователь Evol-Cardiac Medical Laboratory (AEC)'],
    ['Образование','Skyhaven University Medical School — магистратура и PhD'],
    ['В вуз поступил','в 14 лет (2035 год)'],
    ['Открытие','гены Evol влияют на скорость мутации клеток при развитии сердца'],
    ['Награды','Starcatcher Award (2046, в 25 лет) · Linde Award (самый молодой обладатель)'],
    ['Публикации','30+ работ как первый автор в журналах с IF &gt; 9.0'],
    ['Первая в истории','операция регенерации аортального клапана с Evol-технологией'],
    ['Также','PhD-руководитель Skyhaven Medical'],
    ['Профильно','коррекция врождённых дефектов · регенерация клапанов · трансплантация сердца'],
  ],
  'Лор и предыстория':[
    ['Семья','родители — врачи без границ, часто в командировках'],
    ['Детство','много времени проводил один'],
    ['MC','друзья с детства, потеряли контакт когда Зейн уехал'],
    ['Воссоединение','через 10+ лет — Зейн стал её лечащим врачом по просьбе её бабушки Жозефины'],
    ['Дружит с','Калебом'],
    ['Учитель','профессор Dr. Noah (продолжают совместные исследования)'],
    ['Соперник','Carter — однокурсник, ушёл в Protocore enhancement'],
    ['Уильям','друг, превратился в Wanderer на горе Eternal — Зейн был вынужден остановить его'],
    ['Dawnbreaker','альтер-эго из повторяющихся снов (с 12 лет)'],
    ['Миф Tower of Secrets','Foreseer — бессмертный эмиссар бога Astra'],
    ['Миф Snow\'s Embrace','река Дань и безымянная гора Snowfield, где обитает божество'],
  ],
  'Привычки и слабости':[
    ['Сладкое','тайно любит, особенно горячее какао'],
    ['Алкоголь','не пьёт — одна конфета с ликёром делает пьяным'],
    ['Сон','с 12 лет — кошмары, часто избегает сна'],
    ['Когда болеет','отказывается от лекарств, требует какао'],
    ['Бильярд','играет отлично, учитель строгий'],
    ['Резьба по нефриту','освоил мастерски (через Protocore)'],
    ['Akso рутина','тайком ходил с медперсоналом за молочным чаем'],
    ['Косы','научился плести, ухаживая за детьми в больнице'],
    ['Темп','трудоголик, часто работает ночью'],
    ['Эвол','при использовании температура вокруг — экстремально низкая'],
  ],
  'Любопытные мелочи':[
    ['Тихо любит','маленьких животных'],
    ['Отдых','путешествия, музеи, парки, спорт'],
    ['Соло-режим','наслаждается одиночеством'],
    ['Чувство юмора','серьёзным лицом — самые несерьёзные вещи'],
    ['Импровизация','неожиданно изобретателен'],
    ['Голос JP','Takuya Satou'],
    ['Голос EN','Strife (после смены VA в 2026)'],
...
function render(){
  ...
  // факты по категориям
  const factsHTML=Object.entries(FACTS).map(([cat,items])=>`
    <div class="nws-facts-group">
      <h4 class="nws-fg-h">${cat}</h4>
      <dl>${items.map(([k,v])=>`<div class="nws-fact"><dt>${esc(k)}</dt><dd>${v}</dd></div>`).join('')}</dl>
    </div>`).join('');
  ...
  host.innerHTML=`
    <div class="nws">
      ...
      <details class="nws-sect">
        <summary>Справка о докторе <span class="nws-rule"></span></summary>
        <div class="nws-sect-body">${factsHTML}</div>
      </details>
