...
const PROFILE={
  ...
  people:[
    ...
    ['Клопидогрель','Белка-питомец Зейна. Он подкармливает её, и она отвечает ему доверием — редкая для него тёплая привязанность'],
    ['Пай (Pie)','Белая лиса доктора Ноа. Имя получил за то, что однажды съел шесть мясных пирогов за один присест'],
    ['Бай Цзэ','Мифические белые звери-компаньоны, неотлучно следуют за Зейном в мифе «Снежные объятия» (Шици, Эршии и другие)'],
