...
const PROFILE={
  ...
  people:[
    ...
    ['Пай (Pie)','Рыжая лиса доктора Ноа. Имя получила за то, что однажды съела шесть мясных пирогов за один присест'],
    ['Бай и Шубай','Bai Ze — мифические овцы-компаньоны, неотлучно следуют за Зейном в мифе Snow\'s Embrace'],
